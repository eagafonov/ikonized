...
//FIXME #include "wx/defs.h"

#include "sizer_defs.h"
#include "size.h"
...
{
public:
    virtual void SetMinSize(const wxSize& size) = 0;
    virtual const wxSize &GetSize() = 0;
    virtual void SetContainingSizer(const wxSizer *) = 0;
    virtual const wxSize &GetEffectiveMinSize() = 0;
    virtual void SetSize(int x, int y, int w, int h, int flags) = 0;
    virtual void Destroy() = 0;
    virtual void Show(bool) = 0;
    virtual bool IsShown() = 0;
    virtual void SetSizeHints(int, int, int, int) = 0;
    virtual int  GetMaxWidth() = 0;
    virtual int  GetMaxHeight() = 0;
    virtual const wxSize &GetVirtualSize() = 0;
    virtual void SetVirtualSizeHints(int, int, int, int) = 0;
    virtual const wxSize &GetMaxSize() = 0;
    virtual const wxSize &GetClientSize() = 0;
    virtual int  AdjustForLayoutDirection(int, int, int) = 0;
    virtual const wxPoint &GetPosition() = 0;
};
class wxClientData;
...
// FIXME WX_DECLARE_EXPORTED_LIST( wxSizerItem, wxSizerItemList );

template <class T>
class ptr_list: public std::list<T*>
{
public:
    // size_t GetCount() const {return size();}
};
typedef ptr_list<wxSizerItem> wxSizerItemList;
...
template<class T>
class simple_array: public std::vector<T>
{
    typedef std::vector<T> BASE;

public:
    int GetCount() const {return BASE::size();}
    
    void SetCount(size_t new_size)
    {
...
typedef simple_array<int> wxArrayInt;
...
public:
...
#ifdef CLASS_NAME
        strncpy(ClassName, "wxSizer", sizeof(ClassName));
#endif
    }
    virtual ~wxSizer();
    ...
    virtual wxSizerItem* Append(wxSizerItem *item);
